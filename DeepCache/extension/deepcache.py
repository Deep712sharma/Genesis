class DeepCacheSDHelper(object):
    ...
    def set_params(self,cache_interval=1, cache_branch_id=0, skip_mode='uniform', interval_seq=None):
    ...
    def is_skip_step(self, block_i, layer_i, blocktype = "down"):
        ...
        interval_seq = self.params.get('interval_seq', None)
        
        if interval_seq is not None:
            if (self.cur_timestep-self.start_timestep) in interval_seq: return False
